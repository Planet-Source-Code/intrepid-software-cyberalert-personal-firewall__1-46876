...
Begin VB.Form frmLogTraffic 
   ...
   End
End
Attribute VB_Name = "frmLogTraffic"
...
Kill App.Path & "\Logs\Traffic" & AscDate & ".txt"
txtDesc.Text = ""
...
On Error GoTo errer
ff = FreeFile
Open App.Path & "\Logs\Traffic\" & AscDate & ".txt" For Input As #ff
