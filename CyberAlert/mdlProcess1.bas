...
Public Sub Err_Dll(Optional one, Optional two, Optional three, Optional four)

End Sub
Public Sub Err_Vb(Optional one, Optional two, Optional three, Optional four)
...
On Error GoTo VB_Error
    ...
    If Function_Exist("kernel32.dll", "CreateToolhelp32Snapshot") = True Then
        ...
        'hSnapShot = CreateToolhelp32Snapshot(TH32CS_SNAPMODULE, lProcessID): If hSnapShot = INVALID_HANDLE_VALUE Then Call Err_Dll(Err.LastDllError, "CreateToolHelp32Snapshoot failed", sLocation, "Module32_Enum")
...
On Error GoTo VB_Error
    ...
    hSnapShot = CreateToolhelp32Snapshot(TH32CS_SNAPPROCESS, 0&): If hSnapShot = INVALID_HANDLE_VALUE Then Call Err_Dll(Err.LastDllError, "CreateToolHelp32Snapshoot failed ::: INVALID_HANDLE_VALUE", sLocation, "Process32_Enum")
...
On Error GoTo VB_Error
    ...
    If hHandle = 0 Then
        ...
        If Err.LastDllError <> 9999 Then Call Err_Dll(Err.LastDllError, "GetModuleHandle failed ::: MOD_NOT_FOUND", sLocation, "Function_Exist")
        
        hHandle = LoadLibraryEx(sModule, 0&, 0&): If hHandle = 0 Then Call Err_Dll(Err.LastDllError, "LoadLibraryEx failed", sLocation, "Function_Exist")
